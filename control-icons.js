svgPanZoom.controlIcons = {
  add: function(args) {
    var svgWidth = args.svgWidth,
      svgHeight = args.svgHeight,
      svg = args.svg,
      viewport = args.viewport,
      selector = args.selector,
      svgPanZoomInstance = args.svgPanZoomInstance;
      ...
      var controlsSelection = document.createElementNS('http://www.w3.org/2000/svg', 'g');
      controlsSelection.setAttribute('id', 'svg-pan-zoom-controls');
      controlsSelection.setAttribute('transform', 'translate(' + ( svgWidth - 70 ) + ' ' + ( svgHeight - 76 ) + ') scale(0.75)');
      controlsSelection.setAttribute('class', 'svg-pan-zoom-control');
      ...
      controlsSelection.appendChild(zoomInControl);
      ...
      controlsSelection.appendChild(resetPanZoomControl);
      ...
      controlsSelection.appendChild(zoomOutControl);
      ...
      svg.appendChild(controlsSelection);
